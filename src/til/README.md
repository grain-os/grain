...
A short atom form (`%tile`) is proposed and **held for the maintainer's word**; until then the long word serves everywhere. Pedestals here do not seat `%tile` — they name living counts from the marked-value brief.
