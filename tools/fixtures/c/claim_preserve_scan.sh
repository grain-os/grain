...
# door for the maintainer rather than a loosening a lap may take for itself.
#
...
while IFS= read -r path; do
  ...
  # drift should pass is a door for the maintainer rather than a loosening a lap may take.
