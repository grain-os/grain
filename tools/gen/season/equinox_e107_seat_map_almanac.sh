...
entry = (
    "### 111. Equinox e107 seat map: corrected close path after seat 110 spent on e106; proposes seat 112 CLOSE CHOIR as check·test·prepare; bundle as crossing mode; shred the maintainer-gated; ch5+ch6 close-seat row still parked.\n"
    ...
    "bundle crossing mode · shred the maintainer-gated · fork not_consumed · "
