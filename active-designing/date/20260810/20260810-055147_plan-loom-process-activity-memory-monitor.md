...
- **`loom` is already spoken in the tree, three times, as a live metaphor.** The reds-first rule (`.claude/rules/reds-first.md`) closes with *"a lantern that fires twice should become a loom"* — a **loom** there is a caught, recurring failure promoted into a permanent guard. A prior collision-check (`session-logs/20260808-201635_...kyri`) flagged `Loom (3 — reds-first metaphor)` and *set it aside* for exactly this reason, and the civic-loom research (`external-research/20260808-200709_...md`) names "Loom" only to decline it, since reusing it would blur the seated image.
