...
**Room:** mixed -- the three readings are checkable and bound by a green witness; the amendment proposed at the close is a proposal and waits for the maintainer's word.
...
Whether Gauge takes a fifth field is the maintainer's word. It touches a seated register, and a register
