...
**Voice:** Kyri
**Status:** Proposed -- **mixed room**: every measurement below is checkable and reproduced by claim 9 of [`../mantra/src/weave_apply_witness.rye`](../mantra/src/weave_apply_witness.rye); the three doors are vision until the maintainer's word seats one
