...
- **r3 — The census travels.** Render the census to a `format cion-survey-v1` Kyri record — the VOLS ledger LOWE reads — and parse it back byte-for-byte; unknown/missing field · bad header each refuse. A durable artifact, not a console print that scrolls away.
