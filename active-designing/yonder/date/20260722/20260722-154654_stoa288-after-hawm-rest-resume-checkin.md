...
*An Acme Corporation employee reading this gets the fork after the maintainer said continue: the HAWM deepen chain stays GREEN and folded (AVD down, harvest Kyri kept), the Pixel is still on USB, and the next door is a sized resume -- not fleets, not gold, and not a silent reopen of held seasons.*
