...
The OpenCode loop inherits the two clauses the maintainer named for the Codex molt:
...
the maintainer's word to give, the same way every other seating in this tree is.
...
This page documents the switch; the maintainer's word performs it.
