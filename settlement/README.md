...
Sui splits the world into **owned** objects (a fast path that leaves one owner's affairs outside global ordering) and **shared** ones (paid for by consensus). Settlement keeps that split honestly:
...
*May a point settle once under its rightful place, its powers move only by a signed hand, and its keys heal while the deed sleeps on.*
