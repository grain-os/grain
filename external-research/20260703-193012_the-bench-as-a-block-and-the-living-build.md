...
One word in the commissioning question, *Kyri*, holds no seat in LEXICON and is read here purely as the seam's plain description -- inter-agent message passing. If it is a name candidate, it parks in RTAC on the maintainer's word, per the standing law.
