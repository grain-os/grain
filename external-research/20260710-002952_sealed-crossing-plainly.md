...
Kyri = letter (one record). Amphora = crate (many). MUR = coin inside (was MALA). Comlink = sea. Kumara = stamp. Amber = cellar left and returned to. Granary = weave-sharing surface (name seated). Mandi = vessel market floor (name seated). Pond = customs at receipt. No duty overlaps.
