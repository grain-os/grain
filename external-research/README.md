...
**Research for understanding -- advice stays elsewhere.** Surveys and memos here frame understanding only -- they recommend no purchase, no treasury action, and no licensed professional course. Policy and money choices belong to the maintainer in their own chapter. Each dated exploration carries the boundary in its status line. Filing law: [`../ORGANIZING.md`](../ORGANIZING.md) - register law (proposed): [`../context/TWO_ROOMS.md`](../context/TWO_ROOMS.md).
