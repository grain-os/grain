...
| `20260717.173848` | [Foundations archive, Kyri compress, and LLM context](20260717-173848_foundations-archive-kyri-compress-for-llm-context.md) | Decline bulk archive / Kyri essays; extend docs compression with COMPASS + Kyri compass card; token cost is habit |
...
| `20260717.173427` | [Markup and DSL fusion map -- Glow - Brix - Kyri](20260717-173427_markup-dsl-fusion-map-glow-brix-kyri.md) | One pipeline: Scribble->Brix->Kyri->Mantra->Sala; Glow under TAME; Udon/Sail/Zuse horizon; M1-M5 laps |
...
| `20260715.165000` | [What doesn't nest within a vane -- Glow's three non-vane strata, and Pond's narrowing](20260715-165000_glow-non-vane-strata-and-pond.md) | Substrate (Rye - Kyri - Aurora - Tally), enclosure/build (Pond - Puddle - Maze - Brix), shell (Rishi); the unclaimed Zuse slot; Pond narrows to the isolation-policy substrate |
...
| `20260621-064612` | [966 - Brix vs Kyri -- When to Compose and When to Notate](20260621-064612_brix-vs-kyri.md) | Research |
| `20260621-063112` | [968 - Prompt Caching, ZON, and What Kyri Already Is](20260621-063112_prompt-caching-zon-brix.md) | Research |
