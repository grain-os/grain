...
other file needs to change. The switch is the maintainer's word to give, the same way every other seating in
this tree is.
...
page documents the switch; the maintainer's word performs it.
