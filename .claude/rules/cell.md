...
3. **PROPOSE** — leave proposed until the maintainer's word. Name the proposal in REMEMBER / words; do not treat propose as seat.
...
- **Option 2** still governs piers: Cloud FF-merges `acme-owner`; origin auth-refused is named; home syncs waters.
