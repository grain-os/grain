...
**By name:** `counsel/` - `waymarks/` - `kyri-resins/` - `external-research/` - `gratitude/` -
...
seed manifest is a different wall for a different reason: `template-manifest.kyri` withholds
