...
Plain ASCII survives every tool, terminal, diff, and re-encoding intact. the maintainer asked that documents and commits prioritize it after the operator card corrupted itself in the dark.
