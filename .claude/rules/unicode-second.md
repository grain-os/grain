...
**Seated:** `20260920.133421` on the maintainer's word - **Status:** Living
...
the maintainer asked for the exception to get its own name rather than live only inside a shell script's
