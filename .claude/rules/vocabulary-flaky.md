...
**Seated:** `20260915.183900` on the maintainer's word - **Status:** Living - **Kin:** [`comlink-tendency`](comlink-tendency.md) - [`vocabulary-red-over-bug`](vocabulary-red-over-bug.md) - [`vocabulary-first-resident`](vocabulary-first-resident.md)
...
wins, at whatever length, and sometimes that word is the one the world already uses. the maintainer named
this on `20260915`.
...
Swept in the working tree on the maintainer's word `20260915`: **12 living files**, three of them renamed --
