...
Membership semantics stay outside the pattern entirely: who may join, what departure means, what a reservation's release or expiry implies, and every policy word touching value. The fold computes; it decides nothing. Those words are the maintainer's alone, and no page invents them.
